...
require_once 'resources\views\index\register.php';
require 'public\classes\persons.php'
...
if(count($data) > 0){
  ...
  for($i=0; $i < count($data); $i++){
    ...
    //CRUD------------------------------------------------
    ?>
    <td><a href="index.php?id_up=
    <?php echo $data[$i]['id'];?>">
    <input type="submit" value="Edit" name="access"></td> 
      <!--criando método get, com '?=id'.-->
    
      <td><a onclick="alert()";href="index.php?id=
    <?php echo $data[$i]['id'];?>">
    <input type="submit" value="Exclude" name="access"></td>
    <?php
